...
if(isset($_POST['id_product'])){
    ...
    if(move_uploaded_file($file_tmp, $new_file_path)) {
        ...
        if ($result) {
            ...
            echo json_encode(array('status' => 'success','name' => $name, 'code' => $code, 'img' => $file_name,'size' => $size, 'brand_id' => $brand_id, 'quantity' => $quantity, 'color' => $color, 'description' => $description, 'pin_id' => $pin_id, 'origin' => $origin ));
        } else {
            header('Content-Type: application/json');
