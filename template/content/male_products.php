<?php /* require_once "./handle/filter_products.php" */ ?>
<div class="c-3">
    <!-- CATEGORY -->
    <div class="category">
    ...
    <!-- PRICE -->
    <div class="category">
        <form name="filter-form" id="filter-form" method="POST" action="/handle/filter_products.php">
            <h5>LỌC THEO GIÁ</h5>
            <div class="is-divider"></div>
...
<form id="search-form" method="GET">
    ...
    <div class="wrapper__product" id="product-list">
        <?php
        $db = new Database();
...
<script>
    jQuery(document).ready(function() {
        jQuery('#filter-form').submit(function(e) {
            ...
            jQuery.ajax({
                url: './handle/filter_products.php',
                type: 'POST',
                data: formData,
                success: function(data) {
...
<script>
    jQuery(document).ready(function() {
        jQuery('#search-form').submit(function(e) {
            ...
            jQuery.ajax({
                url: './handle/search_male_handle.php',
                type: 'GET',
                data: data,
                success: function(data) {
                    // Cập nhật danh sách sản phẩm trên layout
...
function fetch_data(page) {
    jQuery.ajax({
        url: '././Function/pagination_test.php',
        method: "POST",
        data: {
            page: page
        },
